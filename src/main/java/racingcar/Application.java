...
public class Application {
    ...
    private static int inputRound() { // 시도 횟수 입력 받기
        String input = Console.readLine();
        int round = validateRound(input); // 유효성 검사 및 변환
        return round;
    }

    private static int validateRound(String input) { // 시도 횟수 유효성 검사
